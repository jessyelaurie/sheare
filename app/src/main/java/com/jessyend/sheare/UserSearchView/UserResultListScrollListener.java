...
public abstract class UserResultListScrollListener extends RecyclerView.OnScrollListener {

    private static final String TAG = UserResultListScrollListener.class.getSimpleName();
    ...
    public UserResultListScrollListener(LinearLayoutManager layoutManager) {
